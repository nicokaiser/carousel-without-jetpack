	...
	public function enqueue_assets() {
		if ( $this->first_run ) {
			...
			wp_enqueue_style(
				...
				plugins_url( 'swiper-bundle.css', __DIR__ ),
				array(),
				$this->asset_version( '11.1.1' )
			);
			wp_enqueue_style( 'jetpack-carousel', plugins_url( 'jetpack-carousel.css', __FILE__ ), array(), $this->asset_version( '11.1.1' ) );
